...
static char	print_nbr_sign(t_pfinfo *inf, unsigned long long *nbr, int radix)
{
	char	sign_ch;
...
static void	print_nbr_prefix(t_pfinfo *inf, char sign_ch)
{
	if (sign_ch)
...
static unsigned long long	get_divisor(t_pfinfo *inf, \
...
static void	put_nbr(t_pfinfo *inf, unsigned long long nbr, \
